...
class DepthwiseConv : public Conv2D {
 public:
  DepthwiseConv(size_t N, size_t CI, size_t H, size_t W, size_t KH, size_t KW, size_t OH, size_t OW, int channel_multiplier = 1, RUNTIME runtime = ROCM, DLDataType data_type = DLFLOAT) : 
