...
file_name = "search_space_32.txt"

wf = open(file_name, "w+")
wf.write("grid  block   register/thread shared_mem/block" + "\n")

ncu_cmd = "ncu -c 1 -k default_function_kernel0   --metrics launch__registers_per_thread,launch__shared_mem_per_block_allocated  python3 profile_by_id.py conv1 32"
