...
class FineCoServiceV1 : public PairService {
 public: 
    ...
    void Accept(int set_stream_num = 2, bool enable_cs=false) {
        ...
        this->GetBestEffectImplList(1.2, _model_name_1, candidate_high_selector_1, test_stream);
        ...
        this->GetBestEffectImplList(1.2, _model_name_2, candidate_high_selector_2, test_stream);
